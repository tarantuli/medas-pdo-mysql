...
readonly class IntegerHandler
{
    public function handle(Field $field): string
    {
        return match (true) {
            ...
            $field->minValue >= - Integer::SIGNED_1_BYTE_MAX
                && $field->maxValue <= Integer::SIGNED_1_BYTE_MAX => 'tinyint',

            $field->minValue >= - Integer::SIGNED_2_BYTE_MAX
                && $field->maxValue <= Integer::SIGNED_2_BYTE_MAX => 'mediumint',

            $field->minValue >= - Integer::SIGNED_3_BYTE_MAX && $field->maxValue <= Integer::SIGNED_3_BYTE_MAX => 'int',

            $field->minValue >= - Integer::SIGNED_4_BYTE_MAX
                && $field->maxValue <= Integer::SIGNED_4_BYTE_MAX => 'bigint',
